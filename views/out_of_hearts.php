...
<head>
    ...
    <title>Out of Hearts - WebQuest</title>
...
<body>
    <div class="main-content">
        <div class="completion-container">
            ...
            <!-- Title -->
            <h1 class="completion-title error">Out of Hearts!</h1>

            <!-- Message -->
            <p class="completion-message">
                Oh no! You've run out of hearts. Don't worry, you can always come back later when your hearts have regenerated. 
